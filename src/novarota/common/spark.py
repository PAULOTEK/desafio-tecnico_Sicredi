...
Centraliza a criacao da SparkSession com as extensoes do Delta Lake. Em um
ambiente Databricks essa configuracao ja vem pronta no cluster; aqui a
replicamos para rodar localmente e demonstrar os mesmos conceitos (Delta,
MERGE, time travel, OPTIMIZE/ZORDER).
"""
